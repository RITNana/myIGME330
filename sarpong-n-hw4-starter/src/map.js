...
const accessToken = "pk.eyJ1IjoidHJ1bHluYW5hIiwiYSI6ImNsdWdldDc4ZzJiaHkya21md2Vha2FsZWEifQ.842MmMt0l_yqIlYIxsnm6w";
let map;
...
const addMarker = (feature, className, clickHandler) => {
	...
	// - the marker is a <div>
	// - <div> classnae will be "poi" - see default-style.css to see the details
	// - notre that web give the <div> the id of the "feature"
	...
	<p class = has-text-weight-bold> Phone: ${feature.properties.phone}</p>`
	;

	// C. Make the marker, add a pop up, add the map
...
const addMarkersToMap = (json, clickHandler) =>{
	geojson = json // replace thje defaul hard-coded JSON data
