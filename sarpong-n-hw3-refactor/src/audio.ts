import { DEFAULTS } from "./enums/audio-defaults.enums";
...
let element: HTMLAudioElement, sourceNode: MediaElementAudioSourceNode, analyserNode: AnalyserNode, gainNode: GainNode, highBiquadFilter: BiquadFilterNode, lowBiquadFilter: BiquadFilterNode;
...
const setupWebaudio = (filePath) => {
    ...
    element = new Audio(); //same as document.querySelector("audio")
